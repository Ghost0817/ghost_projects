...
{
    /**
     * @Route("/{lang}/{category}/{lesson}/", name="tutor_typing")
     *
     * @Template()
     */
    ...
    Lesson $lesson)
    {
        ...
        return $this->render('student/tutor/typing.html.twig',
            array(
                'lang' => $langs,
                'entities' => $entities,
    ...
    /**
     * @Route("/restart/{lang}/{category}/{lesson}", name="tutor_retyping", defaults={
     * }, requirements={
     *     "category": "\d+",
     *     "lesson": "\d+"
     * })
